  ...
  return (
    <>
      ...
      <div
        ...
        className="font-sans text-neutral-100 bg-[#0B0C10] h-[100svh] overflow-y-auto overflow-x-hidden snap-y snap-mandatory selection:bg-[#1a1d24]"
      >
      <Nav />
      ...
      <main>
        ...
        <div
          className="snap-start w-full min-h-[100svh] flex flex-col"
          id="excursions"
        >
          <ExcursionsSection
