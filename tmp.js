...
const data = {
  en: {
    ...
    required: "Required",
    optional: "Optional",
    professional_captain: "Professional captain",
    included_in_price: "Included in price",
    sailor_guide: "Sailor / Tour Guide",
    included: "Included",
    experienced_sailor: "Experienced sailor & guide",
    fuel: "Fuel",
    fully_covered: "Fully covered",
    pay_per_use: "Pay per use",
    not_included: "Not Included",
    fuel_notice: "The boat is provided with a full tank and must be returned full.",
    overview: "Overview",
    boats: {
  ...
  de: {
    specs: { "Length": "L\xE4nge", "Width": "Breite", "Engine": "Motor", "Fuel Tank": "Kraftstofftank", "Water Tank": "Wassertank", "Beds / Cabins": "Betten / Kabinen" },
    premium_amenities: "Premium Annehmlichkeiten",
    image_gallery: "Bildergalerie",
    rates_fees: "Preise & Geb\xFChren",
    show_fewer_amenities: "Weniger anzeigen",
    read_all_amenities: "Alle Annehmlichkeiten",
    service: "Service",
    rate: "Tarif",
    base_prices: "Grundpreise",
    duration: "Dauer",
    type: "Typ",
    price: "Preis",
    options: "Optionen",
    close: "Schlie\xDFen",
    guests_word: "G\xE4ste",
    half_day: "Halbtags",
    full_day: "Ganztags",
    boat_rental: "Bootsmiete",
    base_rate: "Grundtarif",
    skipper: "Skipper",
    required: "Erforderlich",
    optional: "Optional",
    professional_captain: "Professioneller Kapit\xE4n",
    included_in_price: "Im Preis inbegriffen",
    sailor_guide: "Matrose / Reiseleiter",
    included: "Inklusive",
    experienced_sailor: "Erfahrener Matrose",
    fuel: "Kraftstoff",
    fully_covered: "Voll abgedeckt",
    pay_per_use: "Nach Verbrauch",
    not_included: "Nicht inbegriffen",
    fuel_notice: "Das Boot wird vollgetankt \xFCbergeben und muss voll zur\xFCckgegeben werden.",
    ...
    boats: {
      ...
      "gaia-22": { description: "Die Gaia 22 ist ein luxuri\xF6ses, ger\xE4umiges Boot im offenen Stil, das auf maximalen Komfort und puren Genuss zugeschnitten ist." },
  ...
  hr: {
    ...
    premium_amenities: "Premium Sadr\u017Eaji",
    image_gallery: "Galerija",
    rates_fees: "Cijene i naknade",
    show_fewer_amenities: "Prika\u017Ei manje",
    read_all_amenities: "Svi sadr\u017Eaji",
    service: "Usluga",
    rate: "Tarifa",
    base_prices: "Osnovne cijene",
    duration: "Trajanje",
    type: "Tip",
    price: "Cena",
    options: "Opcije",
    ...
    half_day: "Pola dana",
    full_day: "Cijeli dan",
    boat_rental: "Najam broda",
    base_rate: "Osnovna tarifa",
    skipper: "Skipper",
    required: "Obavezno",
    optional: "Opcijonalno",
    professional_captain: "Profesionalni kapetan",
    included_in_price: "Uklju\u010Deno u cijenu",
    sailor_guide: "Mornar / Vodi\u010D",
    included: "Uklju\u010Deno",
    experienced_sailor: "Iskusni mornar",
    fuel: "Gorivo",
    fully_covered: "Potpuno pokriveno",
    pay_per_use: "Po potro\u0161nji",
    not_included: "Nije uklju\u010Deno",
    fuel_notice: "Brod se isporu\u010Duje s punim spremnikom i mora se vratiti pun.",
    overview: "Pregled",
    boats: {
  ...
  it: {
    ...
    rates_fees: "Tariffe e commissioni",
    show_fewer_amenities: "Mostra meno",
    read_all_amenities: "Tutti i servizi",
    service: "Servizio",
    rate: "Tariffa",
    ...
    boat_rental: "Noleggio",
    base_rate: "Tariffa base",
    skipper: "Skipper",
    required: "Obbligatorio",
    optional: "Opzionale",
    professional_captain: "Capitano professionista",
    included_in_price: "Incluso nel prezzo",
    sailor_guide: "Marinaio / Guida",
    included: "Incluso",
    experienced_sailor: "Marinaio esperto",
    fuel: "Carburante",
    fully_covered: "Coperto",
    pay_per_use: "A consumo",
    not_included: "Non incluso",
    fuel_notice: "La barca viene fornita con il serbatoio pieno e deve essere restituita con il pieno.",
    overview: "Panoramica",
    boats: {
      "master-660": { description: "Il Master 660 Open \xE8 un RIB di prima classe con console centrale che unisce prestazioni sportive e comfort." },
      "gaia-22": { description: "La Gaia 22 \xE8 una lussuosa e spaziosa barca open progettata per il massimo comfort." },
      "carnevali-36s": { description: "Il Carnevali 36 \xE8 l'apice del lusso assoluto, un magnifico mega-yacht di 11 metri." }
    }
  },
  nl: {
    specs: { "Length": "Lengte", "Width": "Breedte", "Engine": "Motor", "Fuel Tank": "Brandstoftank", "Water Tank": "Watertank", "Beds / Cabins": "Bedden / Cabines" },
    premium_amenities: "Premium Voorzieningen",
    image_gallery: "Fotogalerij",
    rates_fees: "Tarieven en kosten",
    show_fewer_amenities: "Toon minder",
    read_all_amenities: "Alle voorzieningen",
    service: "Dienst",
    rate: "Tarief",
    base_prices: "Basisprijzen",
    duration: "Duur",
    type: "Type",
    price: "Prijs",
    options: "Opties",
    ...
    required: "Verplicht",
    optional: "Optioneel",
    professional_captain: "Professionele kapitein",
    included_in_price: "Inbegrepen in de prijs",
    sailor_guide: "Zeeman / Gids",
    included: "Inbegrepen",
    experienced_sailor: "Ervaren zeeman",
    fuel: "Brandstof",
    fully_covered: "Inbegrepen",
    pay_per_use: "Naar verbruik",
    not_included: "Niet inbegrepen",
    fuel_notice: "De boot wordt met een volle tank geleverd en dient vol te worden geretourneerd.",
    overview: "Overzicht",
    boats: {
  ...
  sl: {
    ...
    premium_amenities: "Premium Ugodnosti",
    image_gallery: "Galerija",
    rates_fees: "Cenik",
    show_fewer_amenities: "Prika\u017Ei manj",
    read_all_amenities: "Vse ugodnosti",
    service: "Storitev",
    rate: "Tarifa",
    base_prices: "Osnovne cene",
    duration: "Trajanje",
    type: "Vrsta",
    price: "Cena",
    options: "Opcije",
    ...
    half_day: "Poldnevni",
    full_day: "Celodnevni",
    boat_rental: "Najem plovila",
    base_rate: "Osnovna tarifa",
    skipper: "Skiper",
    required: "Obvezno",
    optional: "Opcijsko",
    professional_captain: "Profesionalni kapitan",
    included_in_price: "Vklju\u010Deno v ceno",
    sailor_guide: "Mornar / Vodi\u010D",
    included: "Vklju\u010Deno",
    experienced_sailor: "Izku\u0161en mornar",
    fuel: "Gorivo",
    fully_covered: "Vklju\u010Deno",
    pay_per_use: "Po porabi",
    not_included: "Ni vklju\u010Deno",
    fuel_notice: "Plovilo se preda s polnim rezervoarjem in se mora vrniti polnega.",
    overview: "Pregled",
    boats: {
...
Object.entries(mapLang).forEach(([lang, fileCode]) => {
  ...
  let jsonString = JSON.stringify(langData).slice(1, -1);
