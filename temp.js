export const BOATS = [
  {
    ...
    included: [
      "2 Fiberglass platforms",
      "Compass",
      "Electric bilge pump",
      "Roller bar with awning and navigation lights",
      "Steering wheel -Fiberglass winch",
      "Storage compartments with USB sockets",
      "Shower",
      "Sun cushions"
    ],
    pricingDetails: {
  ...
  },
  {
    ...
    gallery: [
      ...
      "/images/Hedonist_final-19.jpg",
      "/images/Hedonist_final-38.jpg",
      "/images/Hedonist_final-47.jpg",
      "/images/Hedonist_final-50.jpg"
    ],
    ...
    services: [
      ...
      },
      {
        ...
        pricing: [
          ...
          { type: "flat", amount: 1e3, duration: "Full Day" }
        ],
